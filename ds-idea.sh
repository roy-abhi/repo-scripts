...
# @raycast.title ds idea
# @raycast.mode silent
# @raycast.packageName Dev Projects
# @raycast.icon 🧩
#
# Opens datasuite in IntelliJ IDEA
# with the Nix/home-manager env loaded (JDK, sbt, maven…). Works from Raycast
# (searchable as "IDEA · datasuite") and from the terminal (just run this file).
...
/usr/bin/open -na "IntelliJ IDEA" --args "/Users/abhishekroy/Code/personal/datasuite"
