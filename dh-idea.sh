...
# @raycast.icon ☕
#
# Opens datahub in IntelliJ IDEA
# with the Nix/home-manager env loaded (JDK, sbt, maven…). Works from Raycast
# (searchable as "IDEA · datahub") and from the terminal (just run this file).
...
/usr/bin/open -na "IntelliJ IDEA" --args "/Users/abhishekroy/Code/work/sapiens-digital-datahub"
