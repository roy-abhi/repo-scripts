...
# @raycast.icon 🐍
#
# Opens datasuite_genai in VS Code
# with the Nix/home-manager env loaded (JDK, sbt, maven…). Works from Raycast
# (searchable as "Code · datasuite_genai") and from the terminal (just run this file).
...
"/Applications/Visual Studio Code.app/Contents/Resources/app/bin/code" "/Users/abhishekroy/Code/personal/datasuite_genai"
