...
# @raycast.title ms idea
# @raycast.mode silent
# @raycast.packageName Dev Projects
# @raycast.icon ⚙️
#
# Opens mac-setup in IntelliJ IDEA
# with the Nix/home-manager env loaded (JDK, sbt, maven…). Works from Raycast
# (searchable as "IDEA · mac-setup") and from the terminal (just run this file).
...
/usr/bin/open -na "IntelliJ IDEA" --args "/Users/abhishekroy/Documents/mac-setup"
